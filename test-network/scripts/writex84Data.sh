# This script enables the user to write data in the the implicit private data collections of the peers.
...
Writex84Data() {
  ...
  set -x
  export MARBLE=$(echo -n "{\"OrdinalNumber\" :\"30\",\"UnitPrice\":1000000,\"MSPID\":\"Org5MSP\"}" | base64 | tr -d \\n)
  peer chaincode invoke -o localhost:7050 --ordererTLSHostnameOverride orderer.example.com  --tls \
   --cafile ${PWD}/organizations/ordererOrganizations/example.com/orderers/orderer.example.com/msp/tlscacerts/tlsca.example.com-cert.pem  \
  --peerAddresses localhost:7051 --tlsRootCertFiles $PEER0_ORG1_CA --peerAddresses localhost:11051 --tlsRootCertFiles $PEER0_ORG5_CA \
